...
export default function Header() {
    ...
    return (
        <header style={{
            ...
            <div style={{ maxWidth: 1600, margin: '0 auto', padding: '0 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    <div style={{
                        ...
                        boxShadow: '0 0 32px rgba(240, 185, 11, 0.1)',
                        position: 'relative'
                    }}>
                        <svg width="48" height="48" viewBox="0 0 64 64" fill="none" stroke="var(--accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ filter: 'drop-shadow(0 0 8px rgba(240,185,11,0.6))' }}>
                ...
                <div>
                    <h1 style={{ fontSize: 24, fontWeight: 500, letterSpacing: '-0.02em', lineHeight: 1.1 }}>
                        Flash<span style={{ color: 'var(--accent)' }}>Gap</span>
                    </h1>
                    <p style={{ fontSize: 13, letterSpacing: '0.06em', color: 'var(--text-tertiary)', fontWeight: 400, marginTop: 4 }}>
                        Algorithmic Quant Trading
                        {blockNumber && <span style={{ marginLeft: 8, opacity: 0.6 }}>· #{blockNumber.toLocaleString()}</span>}
                    </p>
                </div>
            </div>
